...
function Sidebar() {
  ...
  return (
    <div className="sidebar">
      ...
      {/* Подпись создателя — цвета и шрифт берёт из оформления, поэтому
          читается в любой теме, светлой и тёмной. */}
      <div className="sidebar-foot">{т('Создатель — Мостовой, г. Орск')}</div>
    </div>
  )
}
