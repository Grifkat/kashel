...
/*
 * Названия лѣстницъ, чиновъ, обращенія и ордена — по-русски и въ старой
 * орѳографіи на любомъ языкѣ окна: это имена собственныя эпохи, и переводъ
 * («Provincial Secretary», «Order of St Anne») отнималъ у нихъ весь смыслъ
 * игры. Потому они идутъ мимо словаря — см. НАРОЧНО_РУССКІЯ у сторожа.
 */
export const BRANCH_NAMES: Record<RankBranch, string> = {
  civil: 'Гражданская лѣстница',
  military: 'Военная лѣстница',
  merchant: 'Купеческая лѣстница',
}
...
export function awards(data: VaultData, now: string = today()): Award[] {
  ...
  return [
    ...ladder('anna', 'Орденъ Св. Анны', т('За доходъ, добытый трудомъ'), всегоДохода, [
     ...
     * выдать её дважды.
     */
    ...ladder('george', 'Орденъ Св. Георгія', т('За выдающійся мѣсяцъ'), лучшійМѣсяцъ, [
    ...
    ...ladder('vladimir', 'Орденъ Св. Владиміра', т('За запасъ прочности'), мѣсяцевъЗапаса, [
    ...
    ...ladder('stanislav', 'Орденъ Св. Станислава', т('За порядокъ въ бумагахъ'), дней, [
    ...
    ...ladder('andrew', 'Орденъ Св. Андрея Первозваннаго', т('За чистый капиталъ'), bal.net, [
     ...
     */
    ...ladder('catherine', 'Орденъ Св. Екатерины', т('За капиталъ, который самъ приноситъ'), доляКапитала, [
     ...
     */
    ...ladder('nevsky', 'Орденъ Св. Александра Невскаго', т('Изъ малыхъ денегъ — большія'), ростъОтъНачала, [
    ...
    ...ladder('eagle', 'Орденъ Бѣлаго орла', т('За ростъ дохода къ прошлому году'), ростъГода, [
