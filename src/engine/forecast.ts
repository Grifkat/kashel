...
const transferCategories: Category[] = [
  { id: TRANSFER_IN, name: т('Пополнения со своих счетов'), kind: 'income', icon: 'arrow-left-right', color: '#6aa9ff' },
  { id: TRANSFER_OUT, name: т('Переводы на свои счета'), kind: 'expense', icon: 'arrow-left-right', color: '#6aa9ff' },
]
