...
export const THEMES: ThemeInfo[] = [
  ...
  },
  {
    ...
    name: 'Знамя',
    mode: 'dark',
    about: 'Чёрное, жёлтое, белое — флажные цвета, а не тусклое золото. Мягкие скругления и тёплая подсветка по углам, как у «Обсидиана». Зелёного нет: приход помечен жёлтым.',
    accent: '#ffd700',
  ...
  },
  {
    ...
    name: 'Знамя дневное',
    mode: 'light',
    about: 'То же трёхцветие при свете: белое поле, чёрные буквы, жёлтые заливки и кнопки. Жёлтым по белому не пишут — он там пропадает, — поэтому здесь он работает фоном, а не чернилами.',
    accent: '#ffd700',
  ...
  },
  {
    ...
    name: 'Триколор',
    mode: 'light',
    about: 'Белое поле, синий акцент, красный на расходах — флаг складывается сам, без нарисованного флага. Зелёного нет: приход синий.',
    accent: '#1747c9',
    swatch: ['#f3f6fb', '#ffffff', '#1747c9'],
  },
  {
    id: 'trikolornoch',
    name: 'Триколор ночной',
    mode: 'dark',
    about: 'Тот же флаг по тёмно-синему. Красный и синий на чистом чёрном отдают неоном, а по синеватой темноте ложатся спокойно.',
    accent: '#6b9bff',
